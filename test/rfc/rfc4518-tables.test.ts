...
describe('RFC 4518 Appendix A — Combining Marks', () => {
	test('the frozen ranges match the vendored definitive table', () => {
		// "This table is to be considered definitive for the purposes of
		// implementation of this specification."
		const appendix =
			rfc.split('Appendix A.  Combining Marks').at(-1)?.split('Appendix B.')[0] ?? '';
