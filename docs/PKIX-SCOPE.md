...
- [ ] Validate responder authorization exhaustively.
  ...
  - [ ] Decide and enforce responder-certificate revocation policy (`id-pkix-ocsp-nocheck`, CA-signaled CRL/AIA pointers, or caller-local policy) during OCSP validation. Sources: [`docs/rfc/rfc6960.txt`](./rfc/rfc6960.txt), [`specs/full-standards-compliance.md`](../specs/full-standards-compliance.md), [`src/revocation/ocsp.ts`](../src/revocation/ocsp.ts).
...
- [ ] Decide and document how you will handle revocation checking of the responder certificate; RFC 6960 allows CA signaling for that and also leaves room for local policy. (IETF Datatracker[^rfc6960])
  ...
  - [ ] Define validator policy knobs for responder-cert revocation: honor `nocheck`, require CRL/OCSP evidence, or allow caller-local override when the CA gives no method. Sources: RFC 6960 Section 4.2.2.2.1, [`src/revocation/ocsp.ts`](../src/revocation/ocsp.ts), [`src/revocation/revocation.ts`](../src/revocation/revocation.ts), [`specs/full-standards-compliance.md`](../specs/full-standards-compliance.md).
  - [ ] Add fixtures for each policy branch and document the shipped default so partial RFC 6960 wording stays honest. Sources: [`test/ocsp.test.ts`](../test/ocsp.test.ts), [`test/ocsp-fixtures.test.ts`](../test/ocsp-fixtures.test.ts), [`specs/full-standards-compliance.md`](../specs/full-standards-compliance.md).
...
Implementation-ready master plan: [`specs/full-standards-compliance.md`](../specs/full-standards-compliance.md).
