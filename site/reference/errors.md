...
| `kdf_iterations_exceeded` | MAC or PBES2 iteration count exceeds `maxKdfIterations` (2,000,000 default) |
...
| Code                      | Meaning                                                            |
| ------------------------- | ------------------------------------------------------------------ |
| `kdf_iterations_exceeded` | KDF iteration count exceeds `maxKdfIterations` (2,000,000 default) |
